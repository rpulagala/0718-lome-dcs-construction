...
>
> **📱 Client app (customer portal) — foundation built, local only:** a separate mobile-first, iPhone-style PWA for customers under **`/app`**. Phases **C0 + C1 complete** — `CustomerAccount` + passwordless email-code auth, a mobile app shell (bottom tab bar, sign-in, Home, Profile), and PWA install/offline. Not deployed yet; C2 (project/request tracking) onward pending. Plan + status: [`docs/CLIENT_APP_PLAN.md`](docs/CLIENT_APP_PLAN.md).
>
...
- [Client app plan](docs/CLIENT_APP_PLAN.md) — customer portal (iPhone-style PWA); C0/C1 built
