...
> **Status — 2026-07-14: 129 unit/integration tests (16 files) + 11 Playwright E2E tests passing**, typecheck + lint clean, `next build` green. (Includes the client-portal foundation: `portalSession` unit + `portalAuth` integration — passwordless code request/verify, account creation, and request auto-linking.)
