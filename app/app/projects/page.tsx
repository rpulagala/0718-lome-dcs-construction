  ...
  return (
    <div className="pb-10">
      <div className="flex items-start justify-between px-5 pt-8 pb-3">
        <div>
          <h1 className="text-[28px] font-bold leading-tight tracking-tight text-brand-ink">Projects</h1>
          <p className="mt-0.5 text-sm text-slate-500">Your requests and projects</p>
        </div>
        <Link
      ...
      {empty ? (
        <div className="px-5">
          <div className="rounded-2xl border border-dashed border-slate-300 p-8 text-center">
            <p className="text-sm text-slate-500">You don&apos;t have any requests yet.</p>
            <Link
              href="/app/projects/new"
              className="mt-4 inline-block rounded-full bg-brand-navy px-5 py-2.5 text-sm font-semibold text-white"
            >
              Start a request
            </Link>
          </div>
